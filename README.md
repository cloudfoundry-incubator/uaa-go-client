...
As dependecies for uaa-go-client are not vendored, you should clone the [routing-release](https://github.com/cloudfoundry/routing-release) repo to get compatible versions of its dependencies.
```bash
...
If you are using this client as a dependency in your own go project, import it from `code.cloudfoundry.org/uaa-go-client`, then determine compatible versions of this projects dependencies by cloning [routing-release](https://github.com/cloudfoundry/routing-release).
